...
type MeasuringNodeRepository interface {
	FetchAllPublicNodes() ([]MeasuringNode, error)
	FetchNodesOwnedByUserId(ownerId int64) ([]MeasuringNode, error)
	CreateMeasuringNode(node MeasuringNode, ownerId int64) (MeasuringNode, error)
	FetchAllVisibleNodesByUserId(userId int64) ([]MeasuringNode, error)
	FetchMeasuringNodeById(nodeId int64) (MeasuringNode, error)
	FetchAllMeasuringNodeUserRelations(nodeId int64, userId int64) ([]string, error)
	CreateAuthorisationRelation(node MeasuringNode, user User) error
}
...
func (measuringNodeRepositoryImpl) castListOfMeasuringNodes(input interface{}) (nodes []MeasuringNode) {
	for _, x := range input.([]interface{}) {
		nodes = append(nodes, x.(MeasuringNode))
	}
	return
}

func (m measuringNodeRepositoryImpl) FetchMeasuringNodeById(nodeId int64) (measuringNode MeasuringNode, err error) {
...
func (m measuringNodeRepositoryImpl) FetchAllMeasuringNodes() ([]MeasuringNode, error) {
	params := map[string]interface{}{}
...
func (m measuringNodeRepositoryImpl) CreateMeasuringNode(node MeasuringNode, userId int64) (MeasuringNode, error) {
	params := map[string]interface{}{
		"name":       node.Name,
		"lat":        node.Lat,
		"lng":        node.Lng,
...
func (m measuringNodeRepositoryImpl) FetchNodesOwnedByUserId(userId int64) ([]MeasuringNode, error) {
...
func (m measuringNodeRepositoryImpl) FetchAllPublicNodes() ([]MeasuringNode, error) {
...
func (m measuringNodeRepositoryImpl) FetchAllVisibleNodesByUserId(userId int64) ([]MeasuringNode, error) {
...
func (m measuringNodeRepositoryImpl) CreateAuthorisationRelation(node MeasuringNode, user User) (err error) {
	params := map[string]interface{}{
		"nodeId": node.Id,
		"userId": user.Id,
	}
